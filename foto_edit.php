      ...
      <div class="col-sm-3 bg-body-tertiary">
        ...
        <form action="foto_edit.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="judulfoto" name="judul Foto" value="<?= $judulfoto2 ?>">
          </div>
          <div class="mb-3">
            <label for="deskripsifoto">Deskripsi Foto</label>
            <textarea name="deskripsifoto" id="deskripsifoto" class="form-control" rows="5"><?= $deskripsi2 ?></textarea>
          </div>
          <div class="mb-3">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="foto.php?fotoid=<?= $data['fotoid'] ?>" onclick="return confirm('Yakin Menghapus Foto?')"><button type="button" class="btn btn-danger">Delete</button></a>
